...
**Weapon dice** scale by rarity (Common `1d4` melee → Legendary `3d6+3` melee; ranged dice are one tier higher). See [`docs/design/items.md`](docs/design/items.md) for the full item catalog and [`docs/design/mechanics.md`](docs/design/mechanics.md) for the rules — HP regen, NPC scaling, action costs, day/night view radius, haggle math, and more.
...
- Mechanics and constants live in `docs/design/mechanics.md` — if you touch a combat/economy number in code, update the doc in the same commit
- Item stats (weapons, armor, cells, mods, etc.) live in `docs/design/items.md` — update when items change
