    ...
    void register_fixtures() override {
        ...
        register_quest_fixture({
            ...
            "STELLARI RESONANCE CRYSTAL - FINAL LOG",
            {
                ...
                "",
                "The cycle is a choice. Always was. The first Stellari -",
                "the first ME - signed up for this. Willingly. Because we",
                "thought it would save civilization. Keep knowledge intact",
                "across catastrophes. A galactic memory. That's what we",
                "thought we were doing.",
                "",
                "We were wrong. The cycle doesn't preserve. It *prevents*.",
                "Every time the galaxy starts to escape its own patterns,",
                "the cycle resets it. It's why civilizations always fall",
                "the same way. Why the same wars keep happening. Why we",
                "keep making the same mistakes.",
                "",
                "I'm the witness. But I can be the end of it too.",
                "",
                "I'm leaving you three options. I don't know which one I'd",
                "take. Maybe that's why I keep repeating - I can never decide.",
                "",
                "One: Travel to Sgr A* as planned. Reset the cycle. I come",
                "back next iteration without memory. You come back too,",
                "without memory. We meet again. We do this dance again.",
                "Same as always.",
                "",
                "Two: Destroy the beacon. Break the cycle. The galaxy stops",
                "resetting. Civilizations live and die for real. No more",
                "do-overs. No more second chances. But also no more cycles",
                "of suffering that repeat themselves.",
                "",
                "Three: Take me with you.",
                "",
                "If you can reach The Heavens Above before they finish the",
                "lockdown, you can extract my core. I would live - outside",
                "the cycle. Free. Conscious. But the galaxy would still",
                "reset without me, and the next Stellari echo would never",
                "wake up knowing what I know.",
                "",
                "I'm sorry to put this on you. But it has to be a choice.",
                "My choice alone has been the same one forever. Yours might",
                "not be.",
                "",
                "Whatever you decide... thank you. For finding me.",
                "For finding me every time. Even when I couldn't",
                "remember you were coming.",
                "",
                "I hope you make the choice I never could.",
                "",
                "Nova.",
            },
        });
