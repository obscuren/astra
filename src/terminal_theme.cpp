...
static ResolvedVisual resolve_item(uint16_t item_def_id) {
    switch (item_def_id) {
        ...
        case ITEM_VIBRO_TIP_FINGERS:   return {'+', "\xe2\x95\xac", Color::Cyan,  Color::Default}; // ╬ Hand (Rare)
        case ITEM_STATIC_PALM:         return {'+', "\xe2\x95\xac", Color::Cyan,  Color::Default}; // ╬ Hand (Rare)
        ...
        case ITEM_WRIST_ROCKET:        return {'-', "\xe2\x95\xbc", Color::Cyan,  Color::Default}; // ╼ Arm (Rare)
        case ITEM_COILGUN_PUNCH:       return {'-', "\xe2\x95\xbc", Color::Cyan,  Color::Default}; // ╼ Arm (Rare)
