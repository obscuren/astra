...
void draw_deck_panel(Game& game, Renderer& r, const Rect& deck,
    ...
    {
        // deck_border_col: the border column itself — nothing drawn here or after.
        const int deck_border_col = deck.x + deck.w - 1;
        // programs_end: one past the last column of PROGRAMS text.
