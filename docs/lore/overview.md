...
**Status:** Living document. Captures the full story arc of Astra: setting, deep history, the player's role, the macro-arc, and the deliberate mysteries we leave open. This is the *narrative* doc. Mechanic numbers live in `mechanics.md`. Item stats live in `items.md`.
